...
function createMay2026Menu(periodId: string): CafeteriaMenuDay[] {
    const rows: Array<[string, Array<[string, string, number]>]> = [
        ['2026-05-01', []],
        ['2026-05-04', [['MERCİMEK ÇORBA', 'soup', 130], ['TAVUKLU PİLAV', 'main', 290], ['MEVSİM TÜRLÜ', 'main', 120], ['KEMALPAŞA', 'dessert', 330], ['AYRAN', 'drink', 70]]],
        ['2026-05-05', [['MANTAR ÇORBA', 'soup', 165], ['SEB. ET SOTE/PAT.PÜR.', 'main', 285], ['TAZE FASÜLYE', 'main', 175], ['BULGUR PİLAVI', 'side', 240], ['TULUMBA', 'dessert', 295]]],
        ['2026-05-06', [['EZOGELİN ÇORBA', 'soup', 140], ['BİBER DOLMA/Y.GRN', 'main', 220], ['MANTAR SOTE', 'main', 280], ['BÖREK', 'side', 300], ['KOMPOSTO', 'drink', 175]]],
        ['2026-05-07', [['TAVUK SUYU ÇORBA', 'soup', 145], ['ETLİ KURU FASÜLYE', 'main', 310], ['BEZELYE', 'main', 190], ['PİRİNÇ PİLAVI', 'side', 280], ['CACIK', 'salad', 80]]],
        ['2026-05-08', [['DOMATES ÇORBA', 'soup', 140], ['CORDON BLUE', 'main', 320], ['KARNABAHAR', 'main', 150], ['ERİŞTE', 'side', 300], ['SÜT HELVASI', 'dessert', 250]]],
        ['2026-05-11', [['SEBZE ÇORBA', 'soup', 130], ['FIRIN PİLİÇ/PÜRE', 'main', 230], ['YEŞİL MERCİMEK', 'main', 200], ['ARPA ŞEH.PİLAVI', 'side', 280], ['AYRAN', 'drink', 70]]],
        ['2026-05-12', [['MERCİMEK ÇORBA', 'soup', 140], ['PATLICAN MUSAKKA', 'main', 360], ['KEREVİZ', 'main', 190], ['PİRİNÇ PİLAVI', 'side', 280], ['CACIK', 'salad', 80]]],
        ['2026-05-13', [['EZOGELİN ÇORBA', 'soup', 140], ['İSKENDER', 'main', 400], ['PIRASA', 'main', 120], ['BAKLAVA', 'dessert', 350], ['MEVSİM SALATA', 'salad', 70]]],
        ['2026-05-14', [['YOĞURT ÇORBA', 'soup', 120], ['HARPUT KÖFTE', 'main', 290], ['BROKOLİ', 'main', 120], ['MAKARNA', 'side', 300], ['MEVSİM MEYVE', 'dessert', 70]]],
        ['2026-05-15', [['KRE. MANTAR ÇORBA', 'soup', 155], ['ETLİ NOHUT', 'main', 290], ['FIRIN SEBZE', 'main', 100], ['PİRİNÇ PİLAVI', 'side', 280], ['TURŞU', 'salad', 80]]],
        ['2026-05-18', [['MERCİMEK ÇORBA', 'soup', 140], ['ŞİNİTZEL/PÜRE', 'main', 320], ['TAZE FASÜLYE', 'main', 175], ['MAKARNA', 'side', 300], ['ŞEKERPARE', 'dessert', 330]]],
        ['2026-05-19', []],
        ['2026-05-20', [['DOMATES ÇORBA', 'soup', 140], ['TAVUK DÖNER/P.KIZ.', 'main', 315], ['BEZELYE', 'main', 190], ['PİRİNÇ PİLAVI', 'side', 280], ['AYRAN', 'drink', 70]]],
        ['2026-05-21', [['EZOGELİN ÇORBA', 'soup', 140], ['ORMAN KEBABI', 'main', 330], ['YEŞİL MERCİMEK', 'main', 200], ['MAKARNA', 'side', 300], ['AŞURE', 'dessert', 350]]],
        ['2026-05-22', [['SEBZE ÇORBA', 'soup', 130], ['ETLİ KURU FASÜLYE', 'main', 310], ['BROKOLİ', 'main', 130], ['PİRİNÇ PİLAVI', 'side', 280], ['CACIK', 'salad', 80]]],
        ['2026-05-25', [['TARHANA ÇORBA', 'soup', 140], ['KADIN BUDU KÖFTE/PÜRE', 'main', 330], ['PIRASA', 'main', 120], ['MAKARNA', 'side', 300], ['MEVSİM MEYVE', 'dessert', 70]]],
        ['2026-05-26', []],
        ['2026-05-27', []],
        ['2026-05-28', []],
        ['2026-05-29', []],
